...
public class LoginSteps {
	...
	//Scenario2 : Update Personal Detail
	@Given("Personal Details Page open")
	public void personal_details_page_open() {
	}
	
	@And("Enter PersonalFirstName")
	public void enter_personal_first_name() {
